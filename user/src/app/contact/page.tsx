        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200/80 shadow-xs space-y-6">
              <h2 className="text-lg font-bold text-slate-900">Contact Channels</h2>

              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-amber-50 text-[#DF9F28] rounded-xl flex items-center justify-center shrink-0">
                  <Phone className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs font-bold text-slate-900">Toll-Free Concierge</p>
                  <p className="text-xs text-stone-600 mt-0.5">+91 1800-419-7000</p>
                  <p className="text-[10px] text-stone-400">Mon - Sat: 9:00 AM – 9:00 PM IST</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-stone-600 mt-0.5">concierge@judescart.com</p>
                  <p className="text-[10px] text-stone-400">Typical response under 2 hours</p>
                </div>
              </div>
            ...
            {/* Quick Links */}
            <div className="bg-amber-500/10 border border-amber-300/60 rounded-3xl p-6">
              <div className="flex items-center gap-2 mb-2">
                <Sparkles className="w-4 h-4 text-[#DF9F28]" />
                <h3 className="text-xs font-bold text-slate-900 uppercase">Self-Service Portals</h3>
              </div>
              <div className="space-y-2 text-xs font-bold">
                <Link href="/track-order" className="block text-slate-800 hover:text-[#DF9F28]">
                  → Track Live Package Status
                </Link>
                <Link href="/returns" className="block text-slate-800 hover:text-[#DF9F28]">
                  → Initiate Returns or Exchange
                </Link>
                <Link href="/faq" className="block text-slate-800 hover:text-[#DF9F28]">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200/80 shadow-xs">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-stone-200 text-xs sm:text-sm focus:outline-none focus:border-[#DF9F28]"
                      />
                    </div>
                    <div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-[#111111] hover:bg-[#DF9F28] text-white hover:text-slate-950 font-bold text-xs sm:text-sm rounded-xl transition-all shadow-xs cursor-pointer flex items-center justify-center gap-2"
                  >
