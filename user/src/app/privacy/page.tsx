      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-stone-200/80 shadow-xs space-y-8">
          ...
          <div className="prose prose-stone max-w-none text-xs sm:text-sm text-stone-600 space-y-6 leading-relaxed">
            <section>
              <h2 className="text-base font-bold text-slate-900 mb-2">1. Overview & Commitment</h2>
              <p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1.5">
                <li><strong className="text-slate-800">Account & Identity:</strong> Name, email address, phone number, and delivery addresses.</li>
                <li><strong className="text-slate-800">Transaction & Payments:</strong> Encrypted payment tokens processed securely via PCI-DSS compliant gateways (Razorpay, UPI). We do not store raw card numbers.</li>
                <li><strong className="text-slate-800">Lucky Draw & Gamification:</strong> Ticket numbers, streak claims, and reward redemption histories.</li>
                <li><strong className="text-slate-800">Device & Usage:</strong> Browser fingerprint, IP address, and cookie identifiers for session management.</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-base font-bold text-slate-900 mb-2">4. 256-Bit SSL Encryption</h2>
              <p>
            ...
            <section>
              ...
              <p>
                If you have questions regarding your data or wish to request data erasure, please contact us at <a href="mailto:privacy@judescart.com" className="text-[#DF9F28] font-bold underline">privacy@judescart.com</a>.
              </p>
            </section>
          </div>
        </div>
