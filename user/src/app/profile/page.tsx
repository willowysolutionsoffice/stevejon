      ...
      <main className="flex-1 py-10 md:py-16">
        <div className="sj-container space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-6 border-b border-slate-200/80">
            ...
            >
              <Package className="w-4 h-4 text-[#DF9F28]" />
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold tracking-wider uppercase transition-all shrink-0 cursor-pointer ${
                    activeTab === tab.id
                      ? 'bg-[#0A192F] text-white shadow-xs'
                      : 'bg-white text-[#555555] hover:bg-[#F8FAFC] hover:text-[#111111] border border-slate-200'
                  }`}
                >
          ...
          {activeTab === 'profile' && (
            <div className="max-w-xl bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6">
              <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                ...
                <div>
                  <h3 className="text-base font-bold text-[#111111]">{profileData.name || 'JudesCart Member'}</h3>
                  <p className="text-xs text-[#555555]">{profileData.email}</p>
                </div>
              </div>
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#F8FAFC] border border-slate-200 rounded-xl text-xs text-[#111111] focus:outline-none focus:border-[#DF9F28]"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-100 border border-slate-200 rounded-xl text-xs text-[#888888] cursor-not-allowed"
                  />
                </div>
                ...
                <button
                  ...
                  className="px-6 py-3 bg-[#DF9F28] hover:bg-[#C6891E] text-[#111111] rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-xs flex items-center gap-2 cursor-pointer"
                >
                  {savingProfile ? <Loader2 className="w-4 h-4 animate-spin" /> : <Check className="w-4 h-4 text-[#111111]" />}
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#DF9F28] hover:bg-[#C6891E] text-[#111111] rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
                >
                    ...
                    >
                      <div className="space-y-2 text-xs">
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[#111111] text-sm">{addr.name}</span>
                          {addr.isDefault && (
                            <span className="px-2.5 py-0.5 rounded-full bg-[#FEF8EE] text-[#DF9F28] font-bold text-[10px] uppercase tracking-wider border border-[#DF9F28]/30">
                              Default Address
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-3 pt-3 border-t border-slate-100 text-xs">
                        <button
                          ...
                          className="text-[#DF9F28] hover:text-[#C6891E] hover:underline font-semibold flex items-center gap-1 cursor-pointer"
                        >
            ...
            <div className="space-y-6">
              ...
              {loadingTickets ? (
                ...
                <div className="p-12 bg-white rounded-3xl border border-slate-200 text-center space-y-3">
                  ...
                  <Link
                    href="/product"
                    className="inline-block px-5 py-2.5 bg-[#DF9F28] hover:bg-[#C6891E] text-[#111111] text-xs font-bold uppercase rounded-full tracking-wider transition-all"
                  >
                  ...
                  {tickets.map((t, idx) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {t.isWinner ? (
                          <span className="px-2.5 py-0.5 rounded-full bg-[#FEF8EE] text-[#DF9F28] text-[10px] font-bold uppercase border border-[#DF9F28]/30">
                            WINNER!
                          </span>
                        ) : (
                          <span className="px-2.5 py-0.5 rounded-full bg-slate-100 text-[#555555] text-[10px] font-semibold uppercase">
                            Registered
                          </span>
                        )}
                      </div>
                      ...
                      <div className="space-y-1">
                        <p className="text-sm font-bold font-mono text-[#111111] tracking-wider">
                          {t.ticketNumber || t.id}
                        </p>
                        <p className="text-xs text-[#555555]">
                          Order: <span className="font-semibold text-[#111111]">{t.orderId}</span>
                        </p>
                      </div>

                      <div className="pt-2 border-t border-slate-100 text-[11px] text-[#888888]">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0A192F]/60 backdrop-blur-xs">
              <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full space-y-6 shadow-2xl border border-slate-200">
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  ...
                  <button onClick={() => setIsAddressModalOpen(false)} className="p-1 text-slate-400 hover:text-[#111111] cursor-pointer">
                    <X className="w-5 h-5" />
                  </button>
                </div>
                ...
                <form onSubmit={handleSaveAddress} className="space-y-3 text-xs">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-[#F8FAFC] border border-slate-200 rounded-xl text-[#111111] focus:outline-none focus:border-[#DF9F28]"
                  />
                  ...
                  <label className="flex items-center gap-2 pt-2 cursor-pointer select-none">
                    <input
                      ...
                      className="rounded text-[#DF9F28] accent-[#DF9F28]"
                    />
                    <span className="text-[#555555]">Set as default delivery address</span>
                  </label>
                  ...
                  <div className="flex gap-3 pt-4 border-t border-slate-100">
                    <button
                      ...
                      className="flex-1 py-3 bg-[#DF9F28] hover:bg-[#C6891E] text-[#111111] rounded-xl font-bold uppercase tracking-wider transition-colors cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-3 bg-slate-100 text-[#111111] rounded-xl font-semibold hover:bg-slate-200 cursor-pointer"
                    >
                      Cancel
                    </button>
                  </div>
