    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-[#888888] mb-6">
          ...
          <span className="text-[#111111]">Returns & Refunds</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs relative">
            ...
            <h3 className="text-sm font-bold text-[#111111] mb-1">Request Return</h3>
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs relative">
            ...
            <h3 className="text-sm font-bold text-[#111111] mb-1">Free Doorstep Pickup</h3>
            <p className="text-xs text-[#555555] leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs relative">
            ...
            <h3 className="text-sm font-bold text-[#111111] mb-1">Instant Refund</h3>
            <p className="text-xs text-[#555555] leading-relaxed">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs max-w-2xl mx-auto mb-12">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-[#111111] mb-1">Order Reference ID *</label>
                <input
                  type="text"
                  required
                  value={orderId}
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm font-mono uppercase focus:outline-none focus:border-[#DF9F28] text-[#111111]"
                />
              </div>

              <div>
                <label className="block text-xs font-bold text-[#111111] mb-1">Reason for Return / Exchange *</label>
                <select
                  required
                  value={reason}
                  onChange={(e) => setReason(e.target.value)}
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm focus:outline-none focus:border-[#DF9F28] bg-white text-[#111111]"
                >
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#DF9F28] hover:bg-[#C6891E] text-[#111111] font-bold text-xs sm:text-sm rounded-xl transition-all shadow-xs cursor-pointer"
              >
        ...
        {/* Policy Details */}
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-4 text-xs sm:text-sm text-[#555555]">
          <h2 className="text-lg font-bold text-[#111111] mb-2">Return Conditions</h2>
