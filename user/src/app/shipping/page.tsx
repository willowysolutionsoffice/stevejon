    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-stone-500 mb-6">
          ...
          <span className="text-slate-900">Shipping & Delivery</span>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200/80 shadow-xs mb-10">
          <h2 className="text-lg font-bold text-slate-900 mb-4">Domestic Delivery Speeds & Rates</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs sm:text-sm">
              <thead>
                <tr className="border-b border-stone-200 text-stone-400 font-bold uppercase text-[11px]">
              ...
              <tbody className="divide-y divide-stone-100 text-slate-700 font-medium">
                ...
                <tr>
                  ...
                  <td className="py-3.5 font-bold text-slate-900">₹199 flat</td>
                ...
                <tr>
                  ...
                  <td className="py-3.5 font-bold text-slate-900">₹349 flat</td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-3xl p-6 border border-stone-200/80 shadow-xs">
            ...
            <h3 className="text-sm font-bold text-slate-900 mb-1">100% Insured In-Transit</h3>
          ...
          <div className="bg-white rounded-3xl p-6 border border-stone-200/80 shadow-xs">
            ...
            <h3 className="text-sm font-bold text-slate-900 mb-1">Eco-Responsible Packaging</h3>
            <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-6 border border-stone-200/80 shadow-xs">
            ...
            <h3 className="text-sm font-bold text-slate-900 mb-1">Live SMS & WhatsApp Alerts</h3>
            <p className="text-xs text-stone-500 leading-relaxed">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200/80 shadow-xs">
          <h2 className="text-lg font-bold text-slate-900 mb-4">Shipping FAQ</h2>
          <div className="space-y-4 text-xs sm:text-sm">
            <div>
              <h3 className="font-bold text-slate-900 mb-1">How can I track my shipment?</h3>
              <p className="text-stone-600 leading-relaxed">
                As soon as your order is dispatched, you will receive a tracking link via SMS, Email, and in your{' '}
                <Link href="/track-order" className="text-[#DF9F28] font-bold hover:underline">
                  Track Order
                </Link>{' '}
                portal.
              </p>
            ...
            <div>
              <h3 className="font-bold text-slate-900 mb-1">What happens if I miss the delivery?</h3>
              <p className="text-stone-600 leading-relaxed">
