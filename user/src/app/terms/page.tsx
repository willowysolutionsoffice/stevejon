    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-stone-200/80 shadow-xs space-y-8">
          <div>
            <div className="w-10 h-10 bg-amber-50 text-[#DF9F28] rounded-xl flex items-center justify-center mb-3">
          ...
          <div className="prose prose-stone max-w-none text-xs sm:text-sm text-stone-600 space-y-6 leading-relaxed">
            ...
            <section>
              <h2 className="text-base font-bold text-slate-900 mb-2">2. Product Pricing & Accuracy</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-slate-900 mb-2">3. Weekly Lucky Draw & Rewards</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-slate-900 mb-2">4. User Conduct & Accounts</h2>
              <p>
