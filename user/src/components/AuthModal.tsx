  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-150">
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-stone-200 overflow-hidden z-10 animate-in zoom-in-95 duration-150">
        ...
        {/* Modal Header */}
        <div className="p-6 pb-4 border-b border-stone-100 bg-white flex items-center justify-between">
        ...
        {/* Tab switcher */}
        <div className="grid grid-cols-2 p-1.5 mx-6 mt-4 bg-stone-100 rounded-2xl">
          <button
            type="button"
        ...
        {/* Security Footer */}
        <div className="px-6 py-3 bg-stone-50 border-t border-stone-100 flex items-center justify-between text-[10px] text-stone-500 font-medium">
