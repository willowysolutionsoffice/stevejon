        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-center space-y-5">
            ...
            <div className="pt-2">
              <Link
                href="/product"
                className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#111111] hover:text-[#DF9F28] transition-colors group focus-visible:outline-none"
              >
          ...
          <div className="lg:col-span-5 relative aspect-square lg:aspect-auto min-h-[340px] lg:h-full bg-slate-100 border-t lg:border-t-0 lg:border-l border-[#E2E8F0]">
            <Image
