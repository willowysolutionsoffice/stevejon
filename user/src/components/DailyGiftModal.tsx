...
export default function DailyGiftModal({ isOpen, onClose }: DailyGiftModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      {/* Dialog Window */}
      <div className="relative w-full max-w-md bg-gradient-to-b from-[#111111] via-[#161616] to-[#0D0D0D] text-white border border-[#DF9F28]/40 rounded-3xl p-6 sm:p-8 shadow-2xl z-10 space-y-6 animate-in zoom-in-95 duration-200">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#DF9F28]/15 border border-[#DF9F28]/40 text-[#DF9F28] text-xs font-bold uppercase tracking-wider">
        ...
        <div className="p-3.5 rounded-2xl bg-black/50 border border-stone-800 space-y-2">
          ...
          <div className="grid grid-cols-7 gap-1.5 pt-1">
            {[1, 2, 3, 4, 5, 6, 7].map((day) => {
              ...
              return (
                <div
                  key={day}
                  className={`flex flex-col items-center justify-center p-1.5 rounded-xl border text-[10px] font-bold ${
                    isPast
        ...
        <div className="relative p-6 rounded-2xl bg-gradient-to-br from-[#DF9F28]/15 via-black/40 to-transparent border border-[#DF9F28]/30 flex flex-col items-center text-center space-y-3">
          
          <div className={`relative w-20 h-20 rounded-2xl bg-[#DF9F28]/20 border border-[#DF9F28]/50 flex items-center justify-center shadow-lg shadow-amber-500/10 ${isOpening ? 'animate-bounce' : ''}`}>
            {claimed ? (
